...
```{r, check_number_events_by_quality_score, fig.width = 15, fig.height = 8}
ggplot(cmpr_events) +
...
```{r, QC_plot_after_compare_filtering, fig.width = 15, fig.height = 8}
...
```{r, plot_some_events_both_both_kind, fig.width = 9, fig.height = 5}
...
```{r, psi_plot_logit, message = FALSE, fig.width = 8, fig.height = 5}
...
```{r, show_overlap_method, echo = F, eval = F}
